/* eslint-disable */
/**
 * This file was copied form mocha, to allow playback to show nice diff between expected
 * result and the result given.
 */
...
exports.map = function(arr, fn, scope) {
  const result = [];
  for (let i = 0, l = arr.length; i < l; i++) result.push(fn.call(scope, arr[i], i, arr));
  return result;
};
...
exports.parseQuery = function(qs) {
  return exports.reduce(
    ...
    function(obj, pair) {
      let i = pair.indexOf('=');
      (key = pair.slice(0, i)), (val = pair.slice(++i));
